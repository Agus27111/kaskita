        ...
        <div class="activity-page">
            ...
            <div class="activity-hero">
                ...
                <div class="activity-hero-content">
                    ...
                    <p class="activity-hero-subtitle">
                        Pantau riwayat pemasukan dan pengeluaran setiap anggota
                        keluarga secara real-time.
                    </p>
                </div>
            </div>
            ...
            <div class="transactions-section">
                        ...
                        <div class="activity-card-inner">
                            <div class="activity-card-left">
                                ...
                                <div
                                    ...
                                    :class="[
                                        item.type === 'expense' &&
                                            'type-icon-wrapper--expense',
                                        item.type === 'income' &&
                                            'type-icon-wrapper--income',
                                        item.type === 'transfer' &&
                                            'type-icon-wrapper--transfer',
                                    ]"
                                >
                                    <TrendingDown
                ...
                <div v-else class="activity-empty">
                    ...
                    <p class="activity-empty-title">
                        Tidak Ada Aktivitas Ditemukan
                    </p>
                    <p class="activity-empty-text">
                        Cobalah mengubah kombinasi filter Anda atau catat
                        transaksi baru.
                    </p>
                    <button @click="resetFilters" class="activity-empty-btn">
                        Hapus Semua Filter
                    </button>
                </div>
            </div>
